...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="row g-3" action="{{ route('supplier.update',$supplier) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                    <label for="supplierName" class="form-label">Supplier Name</label>
                    <input type="text" class="form-control" id="supplierName" value="{{ old('supplierName',$supplier->supplier_name) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="supplierEmail" value="{{ old('supplierEmail',$supplier->supplier_email) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="supplierPhone" value="{{ old('supplierPhone',$supplier->supplier_phone) }}"
                ...
                <div class="col-12">
                    ...
                    <textarea name="supplierAddress" class="form-control" id="supplierAddress" rows="5" cols="10"
                        value="{{ old('supplierAddress') }}" placeholder="Supplier Address">{{ old('supplierAddress',$supplier->supplier_address) }}</textarea>
