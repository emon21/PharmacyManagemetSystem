...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="row my-3" action="{{ route('invoice.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mt-2">
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" id="netTotal" value="{{ old('netTotal') }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" id="totalAmount" value="{{ old('totalAmount') }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" id="totalDiscount" value="{{ old('totalDiscount') }}"
