                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="customerName"
                            ...
                            placeholder="Your Name ... !!" value="{{ old('customerName', $customer->name) }}">
                        @error('customerName')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea name="customerAddress" class="form-control @error('customerAddress') is-invalid @enderror" rows="10"
                            cols="5" id="customerAddress" placeholder="Your Customer Address ... !!" value="{{ old('customerAddress') }}">{{ old('customerAddress') }}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="doctorName"
                            ...
                            placeholder="Your Doctor Name ... !!" value="{{ old('doctorName', $customer->doctorName) }}">
                        @error('doctorName')
                            <span class="text-danger mt-3"> {{ $message }} </span>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea name="doctorAddress" class="form-control @error('doctorAddress') is-invalid @enderror" rows="10"
                            cols="5" id="doctorAddress" placeholder="Your Doctor Address ... !!"
                            value="{{ old('doctorAddress', $customer->doctorAddress) }}">{{ old('doctorAddress', $customer->doctorAddress) }}</textarea>
                        @error('doctorAddress')
                            <span class="text-danger mt-3"> {{ $message }} </span>
                        @enderror
                    </div>
