...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body mt-3">
            <form action="{{route('medicine-stock.store')}}" method="POST">
                @csrf
                <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="batch_id" class="form-control" placeholder="Batch ID" id="batch_id" value="{{old('batch_id')}}">
                        @error('batch_id')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="mrp" class="form-control" placeholder="Enter Your MRP" id="mrp" value="{{old('mrp')}}">
                        @error('mrp')
                            <span class="text-danger mt-3"> {{ $message }} </span>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="rate" class="form-control" placeholder="Enter Your Rate" id="rate" value="{{old('rate')}}">
                        @error('rate')
                            <span class="text-danger mt-3"> {{ $message }} </span>
                        @enderror
                    </div>
